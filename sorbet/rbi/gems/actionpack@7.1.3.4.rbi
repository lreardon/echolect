...
module AbstractController::Collector
  ...
  # source://actionpack//lib/abstract_controller/collector.rb#10
  def cable_ready(*args, **_arg1, &block); end
...
module ActionController::Renderers
  ...
  # source://cable_ready/5.0.5/lib/cable_ready/engine.rb#43
  def _render_with_renderer_cable_ready(operations, options); end
  ...
  # source://cable_ready/5.0.5/lib/cable_ready/engine.rb#34
  def _render_with_renderer_operations(operations, options); end
...
class ActionDispatch::Routing::RouteSet
  ...
  # source://devise/4.9.4/lib/devise/rails/routes.rb#8
  def finalize!; end
