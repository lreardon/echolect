...
class User
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `User` class because it declared `has_many :chat_memberships`.
    ...
    sig { returns(T::Array[T.untyped]) }
    def joined_chat_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def joined_chat_ids=(ids); end

    # This method is created by ActiveRecord on the `User` class because it declared `has_many :joined_chats, through: :chat_memberships`.
    # 🔗 [Rails guide for `has_many_through` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-through-association)
    sig { returns(::Chat::PrivateCollectionProxy) }
    def joined_chats; end

    sig { params(value: T::Enumerable[::Chat]).void }
    def joined_chats=(value); end
  ...
  module GeneratedAttributeMethods
    ...
    def is_lecturer=(value); end

    sig { returns(T::Boolean) }
    def is_lecturer?; end

    sig { returns(T.nilable(T::Boolean)) }
    def is_lecturer_before_last_save; end

    sig { returns(T.untyped) }
    def is_lecturer_before_type_cast; end

    sig { returns(T::Boolean) }
    def is_lecturer_came_from_user?; end

    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def is_lecturer_change; end

    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def is_lecturer_change_to_be_saved; end

    sig { params(from: T::Boolean, to: T::Boolean).returns(T::Boolean) }
    def is_lecturer_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(T::Boolean)) }
    def is_lecturer_in_database; end

    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def is_lecturer_previous_change; end

    sig { params(from: T::Boolean, to: T::Boolean).returns(T::Boolean) }
    def is_lecturer_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(T::Boolean)) }
    def is_lecturer_previously_was; end

    sig { returns(T.nilable(T::Boolean)) }
    def is_lecturer_was; end

    sig { void }
    def is_lecturer_will_change!; end
    ...
    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def saved_change_to_is_lecturer; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_is_lecturer?; end
