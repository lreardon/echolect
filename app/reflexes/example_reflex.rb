...
class ExampleReflex < ApplicationReflex
	...
	def increment
		...
		cable_ready.text_content(selector: '#reload', text: 'Try reloading your browser window. The count is persisted in the session!') if session[:count] == 5

		return unless session[:count] >= 10
